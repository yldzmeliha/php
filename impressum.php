...
?>
   ...
   <article>    
                <p><h1>Impressum</h1>
                  ...
                  Tel: 0123/456789<br/>
                  Fax: 0123/4567890<br/>
                  <a href="mailto:mm@mustermail.de">mm@mustermail.de</a>
                  </p>
                  <p><strong>Vertreten durch:</strong></p>
                  <p>Muster Verwaltungsunternehmen<br/>
                  Musterweg 2<br/>
                  98765 Musterdorf<br/>
                  0987/654321<br/>
                  0987/6543210<br/>
                  <a href="mailto:info@musterverwaltung.de">info@musterverwaltung.de</a>
                  </p>
                  <p><strong>Diese vertreten durch:</strong></p>
                  <p>Mirko Mustermann (Gesch&#228;ftsf&#252;hrer/Vorstand)</p>
                  <p><strong>Umsatzsteuer-ID:</strong><br/>
                  Umsatzsteuer-Identifikationsnummer nach §27a Umsatzsteuergesetz:<br/>
                  Muster-ID123</p>
                  <p><strong>Wirtschafts-ID:</strong><br/>
                  Wirtschafts-IdNr:
                  Muster-ID456</p>
                  <p>&nbsp;</p><p><strong>Berufshaftpflichtversicherung:</strong><br/>
                  Musterversicherung<br/>
                  Musterallee 123<br/>
                  56789 Musterburg<br/>
                  <a target="_blank" href="http://www.musterversicherung.de">http://www.musterversicherung.de</a><br/>
                  Geltungsbereich: Europa</p>
                  <p>
                  <br/><strong>Aufsichtsbeh&ouml;rde:</strong><br/>
                  Musterbeh&#246;rde<br/>
                   <br/>
                  </p>
                  ...
                  <p><strong>Bildnachweise und Quellenangaben</strong></p>
                  ...
                  <ul>
                    ...
                    <li>
                    <a target="_blank" href="https://validator.w3.org/" title="Freepik">Validator</a>
                    </li>

                    <li>
                    <a target="_blank" href="https://www.w3schools.com/php/" title="Freepik">W3Schools</a>
                    </li> 

                  </ul>
                  <br>
                  <p>Dieses Impressum wurde mit Hilfe des <a target="_blank" 
                  href="http://www.hensche.de/impressum-generator.html" title="Impressum Generator">Impressum-Generators</a> von <a target="_blank" 
                  href="http://www.hensche.de/Rechtsanwalt_Arbeitsrecht_Berlin.html" title="Hensche">HENSCHE Rechtsanw&auml;lte, Kanzlei f&uuml;r 
